<template>
    <div class="page page-no-radius">
        ...
        <header-bar title="申请退款" :border="false" :isIos="iosShow" :back="-1" :heights="heights"></header-bar>
        <div class="address" >
                ...
                <van-cell :border="false" class="pb-0">
                    <template #title>
                        ...
                        <span class="fs-14 text-secondary-light"
                            >¥
                            {{
                                (Number(list.goods_sku_price) * Number(form.number))
                                    | NumberFormat(Number(list.goods_sku_price) * Number(form.number))
                            }}</span
                        >
                    </template>
                </van-cell>
            ...
            <van-cell-group :border="false">
                <van-cell :border="false">
                    <template #title
                        ><span class="text-secondary-dark">上传凭证</span><span class="text-gray">（最多上传6张）</span></template
                    ></van-cell
                >
                <!-- 图片上传组件 -->
